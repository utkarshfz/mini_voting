...
//addons
// install libbsd-dev. then add this at the beginning, before global declarations for strlcpy to work
#ifndef HAVE_STRLCAT
/*
...
{
	FILE* f1,*fp,*fpb;
	char user[15],pass[15],prn[15],text[20],ch,sp;
	char str1[6]="Admin";
	char str2[8]="SR@3111";
	int i,no,j,max;
	float tot=0.0;
